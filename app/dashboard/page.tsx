...
export default function Dashboard() {
  return (
    ...
    >
      {/* Título principal */}
      <h1 className="text-4xl font-bold mt-6 md:mt-12 mb-8 text-center dark:text-white">
      ...
      {/* Subtítulo */}
      <h1 className="text-3xl font-bold mt-6 md:mt-12 mb-8 text-center dark:text-white">
        ¿Cómo pueden mis decisiones impactar mi salud en la adultez?
      </h1>

      {/* Texto introductorio */}
      <p className="text-lg text-center mt-8 max-w-4xl px-6 dark:text-white">
        ...
        sigue siendo el factor más importate para lograr llegar a la adultez con una buena salud. En este <strong>dashboard</strong>, podrás explorar, con un enfoque estadístico, cómo
      ...
      <div className="border-4 border-gray-700 dark:border-gray-300 rounded-lg px-6 py-6 w-full max-w-5xl shadow-lg">
        <h2 className="text-2xl font-semibold text-center mb-6 dark:text-white">¿Cómo estamos?</h2>
        <div className="flex flex-col md:flex-row justify-center gap-8 px-4 md:px-8">
          <ExpandableCard
            title="Población Joven"
            value={1800000}
            details={[
              "15-19 años: 280,000",
              "20-24 años: 440,000",
      ...
      {/* Texto introductorio al dashboard */}
      <p className="text-lg text-center mt-8 max-w-3xl px-6 dark:text-white">
      ...
      {/* Contenedor del gráfico de Esperanza de Vida */}
      <div className="border-4 border-gray-700 dark:border-gray-300 rounded-lg px-6 py-6 w-full max-w-5xl shadow-lg mt-10">
        <LifeExpectancyChart />
      </div>

      {/* Explicación antes de los gráficos de mortalidad */}
      <p className="text-lg text-center mt-12 max-w-4xl px-6 dark:text-white">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 mt-10 w-full max-w-6xl">
        ...
        <div className="border-4 border-gray-700 dark:border-gray-300 rounded-lg px-6 py-6 w-full md:w-1/2 shadow-lg">
          <h2 className="text-2xl font-semibold text-center mb-6 dark:text-white">Principales Causas de Muerte</h2>
          <MortalChart />
        </div>

        {/* Gráfico de Mortal2Chart */}
        <div className="border-4 border-gray-700 dark:border-gray-300 rounded-lg px-6 py-6 w-full md:w-1/2 shadow-lg">
          <h2 className="text-2xl font-semibold text-center mb-6 dark:text-white">Años de Vida Perdidos</h2>
          <Mortal2Chart />
        </div>
      </div>

      {/* Resumen final */}
      <p className="text-lg text-center mt-10 max-w-3xl px-6 pb-16 dark:text-white">
