...
export default function MortalidadMaterna1() {
  ...
  const directDeaths = [
    61, 49, 54, 59, 63, 52, 41, 63, 48, 34, 33, 41, 46, 47, 41, 43, 48, 27, 43, 42, 25, 36,
    39, 38, 42, 27, 27, 26, 29, 32, 25, 32, 26, 35, 45, 26, 23
  ];

  const indirectDeaths = [
    27, 24, 16, 19, 17, 19, 15, 21, 22, 17, 26, 18, 20, 11, 6, 15, 6, 22, 19, 13, 10, 21,
    22, 17, 12, 15, 22, 17, 23, 17, 20, 19, 15, 7, 130, 13, 12
  ];

  const totalDeaths = [
    88, 73, 70, 78, 80, 71, 56, 84, 70, 51, 59, 59, 66, 58, 47, 58, 54, 49, 62, 55, 35, 57,
    61, 55, 54, 42, 49, 43, 52, 49, 45, 51, 41, 42, 175, 39, 35
  ];
  ...
  return (
    <div className={`p-6 border-4 rounded-lg shadow-lg ${darkMode ? "bg-gray-800 text-white border-gray-300" : "bg-gray-100 text-gray-900 border-gray-300"}`}>
